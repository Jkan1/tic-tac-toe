 ...
 * @author kan
 */
package com.jkan1.tictactoe.Server;
...
/**
 * A server for a multi-player tic tac toe game.
 *
...
public class Server {
    ...
    public static void main(String[] args) throws Exception {
        try ( var listener = new ServerSocket(Integer.parseInt(System.getenv("SERVER_PORT")))) {
