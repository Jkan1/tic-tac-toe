 ...
 * @author kan
 */
package com.jkan1.tictactoe.Client;
...
public class Client {
    ...
    public Client(String serverAddress) throws Exception {
        ...
        socket = new Socket(serverAddress, Integer.parseInt(System.getenv("SERVER_PORT")));
     ...
     * mark. Then we go into a loop listening for any of the other messages, and
     * handling each message appropriately. The "VICTORY", "DEFEAT", "TIE", and
     * "OTHER_PLAYER_LEFT" messages will ask the user whether or not to play
        ...
        try {
            ...
            while (in.hasNextLine()) {
                ...
                if (response.startsWith("VALID_MOVE")) {
                    ...
                    JOptionPane.showMessageDialog(frame, "Your Opponent left");
                    break;
                }
            }
            out.println("QUIT");
